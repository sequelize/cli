...
`.sequelizerc` / `.sequelizerc.json` / `.sequelizerc.js`. 

The file will get required if available and can therefore be either a JSON file
or a Node.JS script that exports an object. You can also use the `--options-path` option to declare a
