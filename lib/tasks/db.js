...
var getMigrator = function(callback) {
  if (helpers.config.configFileExists() || args.url) {
    ...
    var migrator  = new Umzug({
      ...
      migrationsParams:    [ sequelize.getQueryInterface(), Sequelize ],
      migrationsPath:      helpers.path.getMigrationsPath(),
      migrationsPattern:   helpers.config.supportsCoffee() ? /\.js$|\.coffee$/ : /\.js$/,
      promisifyMigrations: (config.promisifyMigrations !== false)
    });
          ...
          return queryInterface
            ...
            .then(function (result) {
              ...
              return files.filter(function (file) {
                ...
                return file.replace(".js", "").replace(".coffee", "");
              });
            })
            .then(function (files) {
