...
module.exports = {
  ...
  getMigrationPath: function (migrationName) {
    return path.resolve(this.getPath('migrations'), this.getFileName('migration', migrationName));
  },

  getSeederPath: function (seederName) {
    return path.resolve(this.getPath('seeders'), this.getFileName('seeder', seederName));
  },
